...
import 'package:hotel_management/repository/room/room_api.dart';
import 'package:hotel_management/repository/room/room_local.dart';
...
class RoomRepositoryImpl extends RoomRepository {
  ...
  Future<void> saveRoom(Room room) async {
    if (await _isOnline()) {
      ...
      await local.saveRoomsToPref(getRoomsFromCache()..add(room));
    } else {
